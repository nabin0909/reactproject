...
const ProductDetail = () => {
    ...
    const addtocart =()=>{
      ...
      const existingItems = cartItem.find(item=>item.id ===product.id)
      if(existingItems){
        toast.error("product is already present in cart")

      }else{
        cartItem.push(produtItem)
    ...
    <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0">
      <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
        <div class="shrink-0 max-w-md lg:max-w-lg mx-auto">
          <img class="w-full dark:hidden" src={product.image} alt={product.title}/>
          <img class="w-full hidden dark:block" src={product.image} alt={product.title}/>
        </div>
